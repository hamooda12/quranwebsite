...
const [searchText, setSearchText] = useState("");
  ...
  const pagesMap = {
  1: [
    "البقرة","آل عمران","النساء","المائدة","الأنعام","الأعراف","الأنفال","التوبة",
  ...
  2: [
    ...
    "الأحزاب","سبإ","فاطر","يس","الصافات","ص","الزمر","غافر","فصلت",
  ...
  4: [
    ...
    "التكوير","الانفطار","المطففين","الإنشقاق","البروج","الطارق","الأعلى",
...
function handleSearch(text) {
  ...
  for (const page in pagesMap) {
    const found = pagesMap[page].some(surah =>
      surah.includes(text)
    );

    if (found) {
      setNumberOfPage(Number(page));
      break;
    }
  }
}
  ...
  return <div className='main'>
    ...
    <div className="right-panel">
      ...
      <div className="surah-grid-container" id="hi" >
        ...
        <SearchSurah onSearch={handleSearch} />
