...
useEffect(() => {
  if (
    ...
    return    <div className='main'>
          <LeftPanel selectedSurah={selectedSurah} showPlayer={showPlayer} setReacterForMain={setReacterForMain} togglePlay={togglePlay} isPlaying={isPlaying} onPlayReader={handleSurahSelection} isMuted={isMuted}  Muted={Muted} />
            <div className="right-panel">
              
                <div className="surah-grid-container" id="hi" >
                    <h2 className="section-title"><i>🌙</i> السور</h2>
           <GetPage1 setSelectedSurah={setSelectedSurah} onPlay={handleSurahSelection} isSelectReacter={SelctedReactier}  />
           <GetPage2 setSelectedSurah={setSelectedSurah} />
           <GetPage3 setSelectedSurah={setSelectedSurah} />
           <GetPage4 setSelectedSurah={setSelectedSurah} />
